...
## Corpus Check
- 226 files · ~440,224 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1412 nodes · 2429 edges · 125 communities (112 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `881d7bee`
...
Cohesion: 0.14
Nodes (19): getAttendanceOnDate(), filteredMilestones, openAddAssessment(), getDateRangeForClassPeriod(), getDateRangeForPeriod(), exportGradebookToExcel(), formatDate(), { alert, confirm, select } (+11 more)
...
Cohesion: 0.19
Nodes (17): logAssessmentEvent(), ensureIEPPresetsForClass(), state, useMessage(), archiveStudent(), assignSeat(), autoAssignSeats(), moveStudentFromClass() (+9 more)
...
Cohesion: 0.18
Nodes (9): close(), emit, props, useClassroom(), globalMilestones, isAssessmentInSubCohort(), useStudentDossier(), toMinutes() (+1 more)
...
Cohesion: 0.13
Nodes (13): handleRfidAttendanceScan(), logAttendanceEvent(), markAllPresentToday(), masterTimestamp, { push: pushUndo }, syncLateActiveState(), toggleTestDay(), activeClass (+5 more)
...
Cohesion: 0.11
Nodes (31): getDB(), batchSavePhotos(), deletePhoto(), getAllPhotoIds(), getPhoto(), purgeAllPhotos(), savePhoto(), cascadeRenameExpectation() (+23 more)
...
Cohesion: 0.28
Nodes (5): activeSubjectId, activeClassRecord, assessments, gradeMap, useSBarPrintOptions()
...
## Knowledge Gaps
- **491 isolated node(s):** `scanBuffer`, `manifest_version`, `name`, `version`, `description` (+486 more)
...
- **Why does `getDB()` connect `Community 102` to `Community 0`, `Community 2`, `Community 35`, `Community 3`, `Community 109`, `Community 15`, `Community 81`, `Community 21`, `Community 85`, `Community 23`, `Community 28`?**
