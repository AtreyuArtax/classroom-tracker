...
## Corpus Check
- 229 files · ~462,745 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1446 nodes · 2490 edges · 129 communities (116 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `412919a7`
...
Cohesion: 0.07
Nodes (22): props, allCombinedWork, allDossierAssessments, attendanceStats, behaviorCodesMap, currentStudentObj, displayMetaLine, evidenceMix (+14 more)
...
Cohesion: 0.20
Nodes (9): getDateRangeForClassPeriod(), getDateRangeForPeriod(), { alert, confirm, select }, downloadAggregateCsv(), downloadReportCardCsv(), exportContainer, props, showExportMenu (+1 more)

### Community 20 - "Community 20"
Cohesion: 0.13
Nodes (22): getDB(), batchSavePhotos(), deletePhoto(), getAllPhotoIds(), getPhoto(), purgeAllPhotos(), savePhoto(), deleteBehaviorCode() (+14 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (27): auditSettingsIntegrity(), deleteLayoutPreset(), getAcademicTerms(), getAppTheme(), getAttendanceConfig(), getBehaviorCodes(), getGlobalMilestones(), getGradeBuckets() (+19 more)
...
Cohesion: 0.16
Nodes (18): logAssessmentEvent(), classList, gridSize, useGradeEditing(), state, useMessage(), archiveStudent(), assignSeat() (+10 more)
...
Cohesion: 0.13
Nodes (18): handleRfidAttendanceScan(), logAttendanceEvent(), markAllPresentToday(), masterTimestamp, { push: pushUndo }, reconcileStaleTrips(), syncLateActiveState(), toggleTestDay() (+10 more)
...
Cohesion: 0.14
Nodes (11): useClassroom(), activeSubjectId, activeClassRecord, assessments, filteredMilestones, globalMilestones, gradeMap, isAssessmentInSubCohort() (+3 more)
...
Cohesion: 0.06
Nodes (45): activeCategories, activeClassClassCategoriesUpdate(), activeCourseSection, activeUnits, addCategory(), addExpectation(), addUnit(), applyFromPreview() (+37 more)
...
Cohesion: 0.15
Nodes (12): getStudentEffectiveGrade(), isAssessmentApplicableToStudent(), isStudentInSubCohort(), executePrint(), effectiveClass, emit, isSBAR, isSystemPrinting (+4 more)
...
Cohesion: 0.22
Nodes (11): checkResize(), confirmResize(), createClass(), updateActiveClass(), autoPopulateAllElementarySubjects(), ensureIEPPresetsForClass(), loadGradebook(), refreshAllAssessmentStats() (+3 more)

## Knowledge Gaps
- **503 isolated node(s):** `scanBuffer`, `manifest_version`, `name`, `version`, `description` (+498 more)
...
- **Why does `getDB()` connect `Community 20` to `Community 0`, `Community 2`, `Community 3`, `Community 35`, `Community 5`, `Community 81`, `Community 116`, `Community 21`, `Community 85`, `Community 23`, `Community 126`?**
