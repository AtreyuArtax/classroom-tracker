...
## Corpus Check
- 264 files · ~543,721 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1750 nodes · 3007 edges · 156 communities (140 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b7d6a97`
...
Cohesion: 0.05
Nodes (35): archivedRoster, dismissedSuggestions, dismissSuggestion(), filteredArchivedClasses, filteredClassList, getAttendanceOnDate(), globalStudentsOut, modeAllArchivedClasses (+27 more)
...
Cohesion: 0.06
Nodes (27): activeSubjectId, assessments, gradeMap, isAssessmentInSubCohort(), useSBarPrintOptions(), props, allCombinedWork, allDossierAssessments (+19 more)
...
Cohesion: 0.07
Nodes (40): confirmImport(), detectedSubjects, emit, errorMsg, fileInputRef, handleDrop(), handleFileSelect(), isDragging (+32 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (21): useClassroom(), filteredMilestones, globalMilestones, saveStudentGradebookNote(), useStudentDossier(), getDateRangeForClassPeriod(), getDateRangeForPeriod(), toMinutes() (+13 more)
...
Cohesion: 0.10
Nodes (40): saveStudentDemographics(), archiveClass(), archiveStudent(), bulkImportClasses(), clearStudentAbsent(), clearStudentActiveState(), clearStudentLate(), deleteClass() (+32 more)

### Community 24 - "Community 24"
Cohesion: 0.17
Nodes (20): toggleTestDay(), logAssessmentEvent(), gridSize, syncStudentAcrossRefs(), state, useMessage(), archiveStudent(), assignSeat() (+12 more)
...
Cohesion: 0.25
Nodes (15): calculateMostConsistent(), filterAssessmentsForSubject(), getBucketMode(), isCohortMatch(), calculateDecayingAverage(), calculateMode(), calculatePowerLaw(), calculateSBARExpectationMastery() (+7 more)
...
Cohesion: 0.13
Nodes (19): checkResize(), confirmResize(), createClass(), updateActiveClass(), teachingMode, autoPopulateAllElementarySubjects(), detectGradeFromClassName(), ensureIEPPresetsForClass() (+11 more)

### Community 147 - "Community 147"
Cohesion: 0.38
Nodes (9): getSettings(), getAssessmentsByClass(), _calculateCategoryGrade(), calculateClassGrades(), calculateWeightedMedian(), getAssessmentPercentage(), resolveAttemptScore(), getGradesByClass() (+1 more)
...
- **Why does `getDB()` connect `Community 23` to `Community 0`, `Community 2`, `Community 3`, `Community 35`, `Community 9`, `Community 123`, `Community 141`, `Community 15`, `Community 81`, `Community 147`, `Community 20`, `Community 21`, `Community 85`, `Community 149`, `Community 154`, `Community 155`?**
