...
Cohesion: 0.15
Nodes (25): saveStudentDemographics(), archiveClass(), archiveStudent(), bulkImportClasses(), clearStudentAbsent(), clearStudentActiveState(), clearStudentLate(), deleteClass() (+17 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (20): useClassroom(), saveStudentGradebookNote(), useStudentDossier(), _applyDateRange(), deleteEvent(), exportAllData(), getAllEvents(), getDateRangeForClassPeriod() (+12 more)
...
Cohesion: 0.18
Nodes (11): _activateClass(), archiveClass(), computeWeeklyStats(), createClass(), editEvent(), initializeRfidAttendance(), logToggleEvent(), reconcileStaleTrips() (+3 more)

### Community 19 - "Community 19"
Cohesion: 0.18
Nodes (11): archiveStudent(), assignSeat(), getStudentEventHistory(), logAssessmentEvent(), logAttendanceEvent(), logStandardEvent(), permanentlyDeleteStudent(), removeStudent() (+3 more)

### Community 20 - "Community 20"
Cohesion: 0.27
Nodes (4): clearAllData(), getCurrentSchoolYear(), getCurrentSemester(), parseLocal()
...
## Knowledge Gaps
- **171 isolated node(s):** `scanBuffer`, `manifest_version`, `name`, `version`, `description` (+166 more)
