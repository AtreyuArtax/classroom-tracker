...
## Corpus Check
- 229 files · ~462,688 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1444 nodes · 2486 edges · 131 communities (118 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cdf4edc5`
...
Cohesion: 0.08
Nodes (34): getEffectiveClassRecord(), getStudentEffectiveGrade(), getUnitGradeLevel(), addAssessment(), analyticsEvidenceScope, assessmentSortOrder, assessmentStats, availableCourseFilters (+26 more)
...
Cohesion: 0.16
Nodes (18): logAssessmentEvent(), activeClass, gridSize, useGradeEditing(), state, useMessage(), archiveStudent(), assignSeat() (+10 more)
...
Cohesion: 0.13
Nodes (19): handleRfidAttendanceScan(), logAttendanceEvent(), markAllPresentToday(), masterTimestamp, { push: pushUndo }, syncLateActiveState(), toggleTestDay(), getAttendanceOnDate() (+11 more)
...
Cohesion: 0.16
Nodes (10): close(), emit, props, useClassroom(), filteredMilestones, globalMilestones, isAssessmentInSubCohort(), saveStudentGradebookNote() (+2 more)
...
Cohesion: 0.22
Nodes (9): teachingMode, detectGradeFromClassName(), getEffectiveGradeLevel(), parseGradesFromClass(), populateSubjectFromPreset(), populateSubjectFromPresets(), createDefaultElementarySubjects(), DEFAULT_ELEMENTARY_SUBJECTS (+1 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (43): activeCategories, activeClassClassCategoriesUpdate(), activeCourseSection, activeUnits, addCategory(), addExpectation(), addUnit(), applyFromPreview() (+35 more)
...
Cohesion: 0.24
Nodes (10): checkResize(), confirmResize(), createClass(), updateActiveClass(), autoPopulateAllElementarySubjects(), ensureIEPPresetsForClass(), loadGradebook(), refreshAllAssessmentStats() (+2 more)
...
## Knowledge Gaps
- **502 isolated node(s):** `scanBuffer`, `manifest_version`, `name`, `version`, `description` (+497 more)
...
- **Why does `getDB()` connect `Community 20` to `Community 0`, `Community 2`, `Community 3`, `Community 35`, `Community 15`, `Community 81`, `Community 116`, `Community 21`, `Community 85`, `Community 23`, `Community 126`?**
