<template>
  <div class="roster-csv-importer">
    ...
    <div v-if="reconciliationData" class="setup__dialog" role="dialog" aria-modal="true" aria-labelledby="recon-modal-title-imp">
      <div class="setup__dialog-box setup__dialog-box--large setup__dialog-box--recon">
        <h3 id="recon-modal-title-imp" class="setup__dialog-title">Review Roster Changes</h3>
    ...
    <div v-if="importSummary" class="setup__dialog" role="dialog" aria-modal="true" aria-labelledby="summary-modal-title-imp">
      <div class="setup__dialog-box setup__dialog-box--large">
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
          ...
          <div>
            <h3 id="summary-modal-title-imp" class="setup__dialog-title" style="margin: 0;">Roster Import Complete</h3>
...
import { 
  ...
  AlertTriangle, UserCheck, Camera, CheckCircle, UserPlus, Users, Archive 
...
.setup__btn-secondary {
  ...
  border-radius: var(--radius-md, 8px);
  background: var(--bg-tertiary, #272a2e);
  color: var(--text, #ffffff);
  font-size: 0.88rem;
  font-weight: 600;
  cursor: pointer;
...
.setup__btn-secondary:hover:not(:disabled) {
  background: var(--bg-secondary, #181a1b);
  border-color: var(--text-tertiary, #8e8e93);
  color: var(--text, #ffffff);
}

.setup__btn-secondary:active:not(:disabled) {
  opacity: 0.85;
}

.setup__btn-secondary:disabled {
  opacity: 0.5;
  cursor: not-allowed;
}

.setup__dialog-box--recon {
  max-width: 580px !important;
  width: 95vw;
}

.setup__recon-actions {
  display: flex;
  align-items: center;
...
.setup__recon-actions .setup__btn-ghost {
  margin-right: auto;
}
